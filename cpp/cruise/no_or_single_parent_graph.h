...
拜仁小哥先聊了10分钟简历,接着让手写了下union find的算法.算法题是给了个图,类似于树的结构,一个节点可以有多个parent.函数输入是[(parent1,child1),(parent2, child2).....]这样的一个Integer pair list,然后让找只有一个parent或者没有parent的节点,比如1,3,7是根节点,没parent.2,4,6是只有一个parent的节点,就返回[1,3,7],[2,4,6]
