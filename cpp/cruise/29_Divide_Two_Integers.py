...
举个例子，假设除数为3，被除数为16，那么商应该是5。我们从2的0次幂与除数的乘积也即20x3=3开始，幂次逐渐增加，直至超过被除数。可以看出，当
幂次达到2时刚好超过16（3x20+3x21+3x22=21>16）。那么从3x22开始往下累加，3x22=12<16，那么记录下22=4。再看3x21，发现3x22+3x21=18>16
，因此略过21=2。再看3x20，发现发现3x22+3x20=15<16，那么将20=1记录下。次幂累加结束，计算一下商，分别记录了4和1，因此结果4+1=5，
此答案也即为最终的商。
"""
