...
/*
 * practice的整个招聘过程也是很需要耐心.9月5日中午内推,当天下午就收到电面,当时还是感觉很惊喜的,没想到反应这么快;然后约了9月17日的电面,
 * 电面是国人小哥,人很好,题也不难,顺利的解决了.次日收到约Onsite的邮件.

吐槽完了,接下来是面试体验+面经.
以下内容需要积分高于 180 您已经可以浏览

提前一天飞抵NYC,入住酒店,当天没有活动,第二天早上直接去面试.NYC的office在曼哈顿的核心区域,离时间广场五分钟步行距离.practice大概占了
...
第二轮coding,是个在亚麻工作了3年又来practice工作了两年的国人小哥.出了个number of islands的题,follow up是如果二维数组很大很大,memory
